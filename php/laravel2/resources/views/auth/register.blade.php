            ...
            <div class="bg-white w-96 shadow-xl rounded p-5">
                ...
                <form action="{{ route('register_process') }}" class="space-y-5 mt-5" method="post">
                    ...
                    <input name="name" type="text" class="w-full h-12 border border-gray-800 @error('name')
                        border-red-800 @enderror rounded px-3"
                           placeholder="Имя" />
                    @error('name')
                    ...
                    <input name="password_confirmation" type="password" class="w-full h-12 border border-gray-800
                    rounded px-3 @error('password_confirmation') border-red-800 @enderror"
