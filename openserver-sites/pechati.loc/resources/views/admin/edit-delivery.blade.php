    ...
    <table class="admin__table">
        ...
        <tbody>
            <tr>
              ...
              <td>
                    <input type="text" name="name" value="{{ old('name') ?? $delivery->name }}" required>
            ...
            <tr>
              ...
              <td>
                    <input type="text" name="placeholder" value="{{ old('placeholder') ?? $delivery->placeholder }}" required>
            ...
            <tr>
              ...
              <input type="text" name="src" id="input_file" readonly value="{{ old('src') ?? $delivery->src ?? asset('storage/images/no-photo.jpg') }}" />
          ...
          <tr>
            ...
            <td>
              <input type="number" step="any" name="order" value="{{ old('order') ?? $delivery->order ?? 1 }}">
        ...
        <tr>
            <td>alt</td>
            <td>
              <input type="text" name="alt" value="{{ old('alt') ?? $delivery->alt }}">
            </td>
          </tr>
          ...
          <tr>
            <td>title</td>
            <td>
              <input type="text" name="title" value="{{ old('title') ?? $delivery->title }}">
            </td>
          </tr>
