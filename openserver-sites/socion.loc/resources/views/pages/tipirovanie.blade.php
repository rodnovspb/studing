...
@section('content')
  ...
  <section class="typing" id="typing">
    ...
    <ul class="ordered typing__list">
      <li>
        <h3 class="typing__option">Типирование по тестам</h3>
        <div>
          <p>Протипироваться можно по <a href="{{ route('tests') }}">соционическим тестам</a>. Этот способ бесплатный, но часто неточный. По моему опыту тесты показывают верный результат в 30-50% случаев. Связано это с тем, что люди отмечают "своими" качествами те, что хотят развить, что нравится; считают свою ролевую соционическую функцию преобладающей и т.д.</p>
        </div>
      </li>
      <li>
