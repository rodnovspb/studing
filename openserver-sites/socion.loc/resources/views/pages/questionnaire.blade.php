...
<div class="container">
    <section class="questionnaire">
        ...
        <form action="{{ route('send_questionnaire') }}" class="questionnaire__form" method="post">
            ...
            <ul class="questionnaire_meged meged">
                <li>
                    ...
                    <div class="meged__block">
                        <span class="meged__span meged__span--left">Не подходит</span>
                        ...
                        <span class="meged__span meged__span--right">Подходит</span>
                    </div>
                </li>
            ...
            <div class="activity__desc">Отметьте способности. Можно выбирать несколько кнопок</div>
            <ul class="activity">
