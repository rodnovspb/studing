...
<div class="container">
    <section class="questionnaire">
        ...
        <form action="{{ route('send_questionnaire') }}" class="questionnaire__form" method="post">
            ...
            <ul class="questionnaire_meged meged">
                <li>
                    ...
                    <div class="meged__block">
                        ...
                        <span class="meged__span">Подходит</span>
                    </div>
                </li>
                ...
                <li>
                    <div class="meged__question">Вас глубоко интересуют темы, связанные с чувствами и отношениями между людьми. Вы охотно участвуете в обсуждении и решении их личных проблем, стараетесь улучшить взаимопонимание, так как не выносите разногласий и обид в своем окружении. Вам нравится делать другим комплименты, создавать теплую и приятную атмосферу общения. Вам трудно объективно оценивать тех, кому вы симпатизируете и тех, кто вам неприятен. Вы можете ставить личные отношения выше деловых
                    </div>
                    <div class="meged__block">
                        <span class="meged__span">Не подходит</span>
                        <div class="meged__inputs">
            ...
            <div class="activity__desc">Отметьте предпочтения. Можно выбирать несколько</div>
            <ul class="activity">
                @foreach($activities as $activity)
                    <li>
                        ...
                        <div class="activity__btns">
                            ...
                            <label>Нравится в людях <input type="checkbox" name="act_{{ $activity->id }}_like_people"></label>
                            <label>Нейтрально <input type="checkbox" name="act_{{ $activity->id }}_neutral"></label>
                            <label>Не нравится <input type="checkbox" name="act_{{ $activity->id }}_not_like"></label>
            ...
            <textarea class="questionnaire__other" rows="3" name="questionnaire__other" placeholder="Оставьте телеграм, либо другой способ связи. Также здесь можно указать любую полезную для типирования информацию"></textarea>
